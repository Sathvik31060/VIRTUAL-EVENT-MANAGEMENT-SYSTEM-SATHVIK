...
const Home = () => {
    ...
    const sessions = [
        { id: 1, title: 'Webinar on AI Tools', date: '2024-09-28', description: 'Learn the best strategies to engage your community effectively.' },
        { id: 2, title: 'Workshop', date: '2024-10-02', description: 'Discover tips for managing live events on the ConnectSphere platform.' },
    ...
    const upcomingSessions = [
        { id: 4, title: 'Cultural fest', date: '2024-10-10', description: 'Learn how to build meaningful connections in virtual spaces.' },
        { id: 5, title: 'Conference Meet With Microsoft', date: '2024-10-15', description: 'Dive deeper into engagement strategies with hands-on activities.' },
        { id: 6, title: 'Online Conference Meeting', date: '2024-10-20', description: 'Enhance the effectiveness of your webinars with practical tips.' },
    ];
    ...
    const ongoingSessions = [
        ...
        { id: 8, title: 'Open MIC Contest', date: '2024-10-04', description: 'Ongoing strategies for marketing your virtual events effectively.' },
